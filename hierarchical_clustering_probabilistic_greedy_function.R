...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# Esta funcion se ha desarrollado en testing_hierarchical_clusteringV11.R
# y lo que hace es simplemente una aproximacion greedy probabilistica a encontrar 
...
hierarchical_clustering_probabilistic_greedy <- function(D, J, trh=0) {
  # inicio - preparacion
  N <- ncol(D)
...
# ejemplo:
# mergeG <-  hierarchical_clustering_probabilistic_greedy(D = D, J = J, trh=0)
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #  
